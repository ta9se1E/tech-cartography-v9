"""PatentScout AI legacy v8/v7 entry point."""
...
def run_legacy_app() -> None:
  ui_version = resolve_app_ui_version()
  page_title = "Tech Cartography v8" if ui_version == "v8" else "Tech Cartography v7"
  ...
  if ui_version == "v8":
    ...
    with st.sidebar:
      ...
      st.caption(f"UI: {ui_version} (APP_UI_VERSION=v7 で v7 UI)")
