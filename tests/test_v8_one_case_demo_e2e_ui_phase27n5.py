...
def test_intro_case1_real_demo() -> None:
  ...
  assert "Phase27N.5" in text or "render_judge_conclusion_card" in text or "35請求項" in text
  assert "Case 1" in text or "case_01" in text
  assert "claim 本文" in text or "claim" in text
